	...
	function moviePopulator(){
	  ...
	  $.ajax({
	      ...
	      for(var i = 0; i< data.length; i++){
	      	...
	      	if(data[i].category =="futureMarvel" && userSelect == data[i].userID){
	      		//populate into future section using .html
	      		futureContainer.append(futureDiv);
	      	}
	      	else if(data[i].category=="currentMarvel" && userSelect == data[i].userID){
	      		//populate into current section .html
	      		currentContainer.append(futureDiv);
	      	}
	      	else if(data[i].category=="finishedMarvel" && userSelect == data[i].userID){
	      		//populate onto the watched section .html
	      		finishedContainer.append(futureDiv);
	      	}
	      	else if(data[i].category=="notCaughtUpMarvel" && userSelect == data[i].userID) {
	      		notCaughtUpContainer.append(futureDiv);
	      	}
	      	else if(data[i].category=="caughtUpMarvel" && userSelect == data[i].userID) {
